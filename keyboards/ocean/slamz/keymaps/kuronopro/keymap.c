...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYMBOL] = LAYOUT(
        KC_LPRN, KC_LBRC, KC_COLN, KC_RBRC, KC_RPRN, KC_LCBR, LT_PHP,  KC_PIPE, GT_PHP,  KC_RCBR,
        KC_DLR,  KC_AMPR, MIN_ARR, KC_UNDS, KC_SCLN, KC_CIRC, KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI,
        KC_GRV,  KC_AT,   EQL_ARR, KC_HASH, KC_BSLS, KC_EXLM, KC_ASTR, KC_PLUS, KC_PERC, KC_QUES,
